...
constexpr pros::controller_digital_e_t INTAKE_LOWERSTAGE_FORWARD = pros::E_CONTROLLER_DIGITAL_UP;
constexpr pros::controller_digital_e_t INTAKE_LOWERSTAGE_REVERSE = pros::E_CONTROLLER_DIGITAL_DOWN;