...
//Motors
constexpr int RIGHT_FRONT_MOTOR = 4;
constexpr int RIGHT_TOP_MOTOR = -5;
constexpr int RIGHT_BACK_MOTOR = 6;
constexpr int LEFT_FRONT_MOTOR = -3;
constexpr int LEFT_TOP_MOTOR = 1;
constexpr int LEFT_BACK_MOTOR = -2;
...
constexpr char TIPPER_SOLENOID_ADI = 'C';    //Should be C, changed for now.
constexpr int TIPPER_SOLENOID_SMART = 7;
constexpr char EXTENSION_SOLENOID_ADI = 'D';    //Should be C, changed for now.
constexpr int EXTENSION_SOLENOID_SMART = 7;
